(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    function ei(e, t, r) {
      ...
      u.read()
        .then(function t(o) {
          ...
          o = l._rowID;
          for (
            var p = l._rowTag, h = l._rowLength, y = l._buffer, g = i.length;
            s < g;
          ) {
            var v = -1;
            switch (f) {
            ...
            if (-1 < v)
              ((h = new Uint8Array(i.buffer, _, v - s)),
                98 === p
                  ? J(e, o, v === g ? h : h.slice())
                        ...
                        case 73:
                          ...
                          if ((p = c(g))) {
                            if (y) {
                              ...
                              ((v = new P("blocked", null, null)), h.set(f, v));
                            p.then(
                              function () {
                                return U(s, v, g);
                              },
  ...
  (e, t, r) => {
    ...
    async function b(e, t) {
      ...
      try {
        ...
        let b = (0, c.normalizeFlightData)(_.f);
    ...
    async function m(e, t, r, a, l) {
      ...
      let y = fetch(p, {
        ...
        m = new URL(_.url, p);
      return (
        m.searchParams.delete(o.NEXT_RSC_UNION_QUERY),
        {
          url: m.href,
          redirected: b,
          ok: _.ok,
  ...
  (e, t, r) => {
        ...
        if (void 0 === n || W || (X && _))
          if (null !== d && null !== d[0]) {
            let e = d[0],
              r = d[2],
              n = null === h;
            ((C = E(e, r, !1, h, n, X, G, t)), (F = X && n));
          } else if (null !== y) {
            let e = y[0],
              r = y[2],
              n = y[3];
            ((C = E(e, r, n, g, v, X, G, t)), (F = n || (X && v)));
          } else ((C = O(G, X, t, c)), (F = !0));
        else ((C = S(!1, n, G)), (F = !1));
        let Y = l[2],
          z = "string" == typeof Y && "refresh" === l[3] ? Y : w;
        F &&
          null !== z &&
          ((A = M),
          (N = z),
          ...
          2 !== c &&
            ...
            ((p = (a = (function (e, t) {
              ...
              return (
                "refresh" === t[3]
                  ? (r = t)
                  : (((r = R(t, t[1]))[2] = (0, i.createHrefFromUrl)(e)),
                    (r[3] = "refresh")),
                r
              );
            })(r, l))[0]),
    ...
    function m(e, t, r, n, a, l, u, o, i, c, f, d, p) {
      let y,
        g,
        v = t[0],
      ...
      switch (n) {
        case 0:
          ((M = !1),
            (A = void 0 === r || e - r.navigatedAt >= h.DYNAMIC_STALETIME_MS),
            (N = !1));
          break;
        case 1:
          ((A = !1), (M = !1), (N = !1));
      ...
      if (
        ...
        if (null !== a && null !== a[0]) {
          let t = a[0],
            r = a[2],
            u = null === l && 1 !== n;
          ((y = E(t, r, !1, l, u, F, C, e)), (g = F && u));
        } else if (1 === n && F && null !== l)
          ((y = E(null, null, !1, l, !1, F, C, e)), (g = !1));
        else if (1 !== n && null !== u) {
          let t = u[0],
            r = u[2],
            n = u[3];
          ((y = E(t, r, n, o, i, F, C, e)), (g = n || (F && i)));
    ...
    function P(e, t, r, n, a) {
      let l = null;
      return (
        r ? ((l = R(e, t)), a || (l[3] = "refetch")) : (l = n ? R(e, t) : null),
        l
      );
    }
    function S(e, t, r) {
    ...
    function E(e) {
      e.priority === c.PrefetchPriority.Intent &&
        ...
        (null !== v &&
          ...
          ((v.priority = c.PrefetchPriority.Default), V(p, v)),
        (v = e));
    }
    function O() {
      g || ((g = !0), d(A));
  ...
  (e, t, r) => {
    ...
    function D(e, t, r) {
      ...
      let a = new URL(t);
      a.search = "";
      let l = C(e, (0, p.createCacheKey)(a.href, r));
    ...
    async function Y(e, t, r) {
      ...
      try {
        ...
        {
          let n = await fetch(_, { method: "HEAD" });
          if (n.status < 200 || n.status >= 400)
            return (G(e, Date.now() + 1e4), null);
          ((r = n.redirected ? new URL(n.url) : _),
            (t = await ee(er(r, s), p)));
        }
        ...
        let b = (0, d.createHrefFromUrl)(r),
          ...
          E = null !== R && R.includes(o.NEXT_URL),
          ...
          j = "2" === t.headers.get(o.NEXT_DID_POSTPONE_HEADER) || !0;
        {
          ...
          let r,
            n,
            a,
            l = et(t.body, O.resolve, function (t) {
              ...
              (function e(t, r, n, a, l, o, i, s) {
                ...
                if (null !== y)
                  ...
                  y)) {
                    ...
                    let m = r ? o + 1 : o,
                      R = (0, g.createSegmentRequestKeyPart)(u),
                      P = (0, g.appendSegmentRequestKeyPart)(a, t, R);
                    p[t] = e(d, u, f, P, l, m, i, s);
                  }
                else
        ...
        if (!E) {
          let t = (0, c.getFulfilledRouteVaryPath)(n, a, l, E);
  ...
  (e, t, r) => {
    ...
    function d(e, t, r, n, a, l, u, o) {
      ...
      let m = o.collectedDebugInfo ?? [];
      return (
        void 0 === o.collectedDebugInfo && (m = o.collectedDebugInfo = []),
        { tag: f.NavigationResultTag.Async, data: b(c, e, t, a, r, n, l, u, m) }
      );
    }
    function p(e, t, r, n, a, l, o, i, s, c) {
      let d = { scrollableSegments: null, separateRefreshUrls: null },
        p = t.href === a.href,
        h = (0, u.startPPRNavigation)(
          e,
          a,
          l,
          o,
    ...
    function h(e, t, r, n, a, l, o, i, s, c, d, p, h, g, v) {
      ...
      return null !== b
        ? ((0, u.spawnDynamicRequests)(b, t, n, g, _),
          y(b, p, h, _.scrollableSegments, v, t.hash))
  ...
  (e, t, r) => {
    ...
    function f(e, t) {
      ...
      return (
        ...
        (0, l.handleNavigationResult)(o, e, p, !1, d)
      );
    }
    ("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
  ...
  (e, t, r) => {
    ...
    async function T(e, t, { actionId: r, actionArgs: c }) {
      let f,
        ...
        R = (0, _.extractInfoFromServerReferenceId)(r),
        S = "use-cache" === R.type ? (0, _.omitUnusedArgs)(c, R) : c,
    ...
    function j(e, t) {
      ...
      return T(e, l, t).then(
        async ({
          ...
          if (
            ((e.pushRef.pendingPush = _), (a.pendingPush = _), void 0 !== p)
          ) {
          ...
          if (void 0 === p && u === P.ActionDidNotRevalidate && void 0 === i)
            return e;
          if (void 0 === i && void 0 !== p)
            return (0, f.handleExternalUrl)(e, a, p.href, _);
          ...
          let M = (0, R.navigate)(O, m, e.cache, T, l, j, !0, a);
